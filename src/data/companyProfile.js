...
export const values = [
  ...
  {
    title: "Innovation",
    description: "We embrace creative solutions that respond to client challenges.",
    icon: "lightbulb",
  },
  {
    title: "Reliability",
    description: "We deliver on promises with consistency and timeliness.",
    icon: "clock",
  },
  {
    title: "Customer Focus",
    description: "We prioritize client needs to create tailored, impactful results.",
    icon: "heart",
  },
];
...
export const team = {
  leadership: [
    ...
    {
      name: "Arc. Nureni Temitope Fashina",
      position: "Director, Project Implementation",
      role: "Director",
    },
    {
      name: "Mr. Shodeinde Olawale Oladimeji",
...
export const contacts = {
  abuja: {
    label: "Abuja Office",
    address:
      "Suite 203, Anbeez Plaza, Wuse Zone 5, opposite former CAC, Ndola Crescent, Abuja.",
  },
  kaduna: {
    label: "Kaduna Office",
...
export const differentiators = [
  "Expert team with hands-on delivery experience",
  "Customized solutions built around client requirements",
  "Competitive edge through innovation and dependable support",
