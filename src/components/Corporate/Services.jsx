...
const Services = () => {
  return (
    <section id="services" className="relative overflow-hidden bg-slate-900 text-white">
      <div className="absolute right-0 top-20 h-72 w-72 rounded-full bg-sky-500/5 blur-3xl" />
              ...
              {services.map((service, index) => {
                ...
                return (
                  <motion.article
                    ...
                    className="group rounded-[1.65rem] border border-white/10 bg-white/[0.04] p-6 shadow-[0_18px_50px_rgba(2,6,23,0.28)] transition duration-300 hover:-translate-y-2 hover:shadow-xl hover:bg-white/[0.06]"
                  >
                    <div className="flex h-14 w-14 items-center justify-center rounded-2xl bg-sky-500/10 text-sky-300 ring-1 ring-sky-400/15 transition group-hover:bg-sky-500 group-hover:text-slate-950">
                      <Icon size={22} />
                    </div>
